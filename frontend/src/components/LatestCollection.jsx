    ...
    <div className='my-10'>
      <div className='text-center py-8 text-3xl'>
        ...
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
          Discover our latest collections featuring trendy styles, top-quality materials, and must-have pieces for every season. Shop now and refresh your wardrobe!
        </p>
      </div>
      {/* Rendering products */}
